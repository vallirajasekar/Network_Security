...
class DataIngestion:
    ...
    def export_data_info_feature_store(self,dataframe:pd.DataFrame):
        try:
            feature_store_file_paths=self.data_ingestion_config.feature_store_file_path
            #Create Folder 
            
            dir_path=os.path.dirname(feature_store_file_paths)
            os.makedirs(dir_path,exist_ok=True)
            
            dataframe.to_csv(feature_store_file_paths,index=False,header=True)
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Done train test split on Dataframe")
